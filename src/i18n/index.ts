...
export const zhMessages = {
  ...
  myCreations: {
    ...
    upload: {
      ...
      /** 「我的上传」仅走本地上传接口，拖拽链接时提示 */
      localFileOnlyHint: '请上传或拖拽本地图片',
    },
    empty: {
      noWorks: '暂无作品~',
    },
...
export const enMessages = {
  ...
  myCreations: {
    ...
    upload: {
      placeholder: 'Upload or drag local images',
      loading: 'Uploading…',
      ...
      localFileOnlyHint: 'Please upload or drag local images',
    },
    empty: {
    ...
    message: {
      ...
      downloadNoUrl: 'Selected items have no downloadable file URL',
